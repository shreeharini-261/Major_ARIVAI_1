...
export const userOnboarding = pgTable("user_onboarding", {
  ...
  profileMode: varchar("profile_mode").default('regular'), // 'regular', 'irregular', 'ttc', 'menopause', 'pregnancy', 'postpartum', 'puberty'
  
  // Life stage and specialized tracking
  lifeStage: varchar("life_stage"), // 'prepuberty', 'puberty', 'reproductive', 'perimenopause', 'menopause', 'postmenopause'
  pregnancyStatus: varchar("pregnancy_status"), // 'trying', 'pregnant', 'postpartum', 'none'
  lastDeliveryDate: date("last_delivery_date"),
  hasPcos: boolean("has_pcos").default(false),
